...
export default function Table_Type() {
    ...
    const { API, Delete, status } = useContext(Context_Type)
                            ...
                            {API.reverse().map((item) => (
                                <tr class="border-b dark:border-gray-200 text-black hover:bg-gray-200">
                                    ...
                                    <td class="px-2 py-4">
                                        ...
                                        <button className='py-1 px-2 rounded bg-blue-800 text-white mr-2' onClick={() => status(item)}><i class="bi bi-toggle-on"></i> | Show</button>
                                        :
                                        <button className='py-1 px-2 rounded bg-gray-800 text-white mr-2' onClick={() => status(item)}><i class="bi bi-toggle-off"></i> | Off</button>
                                    }
                                    </td>
